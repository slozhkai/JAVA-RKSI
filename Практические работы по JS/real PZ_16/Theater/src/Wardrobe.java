...
class Wardrobe extends Theatre{
    private int hanger; //Количество вешалок
    private int attendant; //Количество гардеробщиков
    private String tima; //Время работы гардероба



    public Wardrobe(String title, String address, int year, String name, boolean canteen, String type, int hanger, int attendant, String tima) {
